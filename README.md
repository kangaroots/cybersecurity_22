...
Note: I have a Macbook pro with a M1 chip and ran into a lot of problems with Docker. I had to install screenfetch inside of Kali Linux with apt install screenfetch in order to make the screenfetch.gif. 
